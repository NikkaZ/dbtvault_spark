{%- macro derive_columns(source_relation=none, columns=none, selected_columns=none) -%}

    {{- adapter.dispatch('derive_columns', 'dbtvault')(source_relation=source_relation, columns=columns, selected_columns=selected_columns) -}}

{%- endmacro %}

{%- macro default__derive_columns(source_relation=none, columns=none, selected_columns=none) -%}
...
{%- macro spark__derive_columns(source_relation=none, columns=none, selected_columns=none) -%}
...
{%- set source_cols = dbtvault.source_columns_from_selected(source_relation=source_relation, selected_columns=selected_columns) -%}
